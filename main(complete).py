...
MESSAGE = """ Fire and Rescue Service required for a reported fire in a detached garage, 48 Fogralea, Lerwick, Shetland Isles, ZE10SE.
"""
...
def startBuzzerSound():
    global RST_CHECK_INTERVAL, STATUS,\
           evacuation_pin, buzzer_pin, beacon_pin, reset_pin, all_clear_pin
    ...
    GPIO.output(buzzer_pin, 0)
    GPIO.output(all_clear_pin, 1)
    time.sleep(0.5)
    GPIO.output(all_clear_pin, 0)
